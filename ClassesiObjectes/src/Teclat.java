public class Teclat {
    ...
    public Teclat(String marca, String model, float preu, boolean esInalambric) {
    ...
    public String toString() {
        return String.format("Teclat %s %s: %.2f€, %s", marca, model, preu, esInalambric ? "inalàmbric" : "amb cable");
    }
}
